...
public class DiscountCode {
    ...
    public DiscountCode(@NotNull UUID owner, @NotNull String code, @NotNull CodeType codeType,
            @NotNull DiscountRate rate, int maxUsage, @NotNull Map<UUID, Integer> usages, @NotNull Set<Long> shopScope,
            double threshold, long expiredTime)
    {
    ...
    public DiscountCode(@NotNull UUID owner, @NotNull String code, @NotNull CodeType codeType,
            @NotNull DiscountRate rate, int maxUsage, double threshold, long expiredTime)
    {
    ...
    public static DiscountCode fromString(@NotNull String string) {
        ...
        return new DiscountCode(data.getOwner(), data.getCode(), data.getCodeType(), rate, data.getMaxUsage(),
                data.getUsages(), data.getShopScope(), data.getThreshold(), data.getExpire());
    ...
    public String saveToString() {
        ...
        DiscountCodeData data = new DiscountCodeData(owner, code, codeType,
                rate instanceof PercentageDiscountRate ? RateType.PERCENTAGE : RateType.FIXED,
                JsonUtil.getGson().toJson(rate), expiredTime, threshold, maxUsage, usages, shopScope);
    ...
    public boolean equals(Object o) {
        ...
        return maxUsage == that.maxUsage && Double.compare(that.threshold, threshold) == 0
                && expiredTime == that.expiredTime && code.equals(that.code) && owner.equals(that.owner)
                && shopScope.equals(that.shopScope) && codeType == that.codeType && rate.equals(that.rate);
    ...
    public String toString() {
        ...
        return "DiscountCode{" + "code='" + code + '\'' + ", owner=" + owner + ", usages=" + usages + ", shopScope="
                + shopScope + ", codeType=" + codeType + ", rate=" + rate + ", maxUsage=" + maxUsage + ", threshold="
                + threshold + ", expiredTime=" + expiredTime + '}';
    ...
    static class PercentageDiscountRate implements DiscountRate {
        ...
        public @NotNull Component format(@NotNull CommandSender sender, @NotNull TextManager textManager) {
            ...
            return textManager.of(sender, "addon.discount.percentage-off", CalculateUtil.multiply(percent, 100))
                    .forLocale();

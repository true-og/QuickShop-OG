    ...
    public void onPrePurchase(ShopInfoPanelEvent event) {
        ...
        Util.mainThreadRun(() -> {
            ...
            switch (codeInstalled.applicableShop(purchaser, shop)) {
                ...
                case APPLICABLE_WITH_THRESHOLD -> quickshop.text()
                        .of(purchaser, "addon.discount.discount-code-applicable", code, quickshop.getEconomy().format(
                                codeInstalled.getThreshold(), shop.getLocation().getWorld(), shop.getCurrency()))
                        .send();
                case NOT_APPLICABLE ->
    ...
    public void onPurchase(ShopPurchaseEvent event) {
        ...
        switch (codeInstalled.applicableShop(purchaser, shop)) {
            ...
            case APPLICABLE -> {
                ...
                quickshop
                        .text().of(purchaser, "addon.discount.discount-code-applied-in-purchase", code, quickshop
                                .getEconomy().format(discounted, shop.getLocation().getWorld(), shop.getCurrency()))
                        .send();
            ...
            case APPLICABLE_WITH_THRESHOLD -> {
                ...
                if (event.getTotal() < codeInstalled.getThreshold()) {
                    ...
                    quickshop.text()
                            .of(purchaser, "addon.discount.discount-code-under-threshold",
                                    quickshop.getEconomy().format(codeInstalled.getThreshold(),
                    ...
                    double discounted = beforeDiscount - event.getTotal();
                    quickshop.text()
                            .of(purchaser, "addon.discount.discount-code-applied-in-purchase", code, quickshop
                                    .getEconomy().format(discounted, shop.getLocation().getWorld(), shop.getCurrency()))
                            .send();

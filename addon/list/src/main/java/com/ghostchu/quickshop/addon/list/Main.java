...
public final class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        plugin.getCommandManager().registerCmd(CommandContainer.builder().prefix("list")
                .description((locale) -> plugin.text().of("addon.list.commands.list").forLocale(locale))
                .selectivePermission("quickshopaddon.list.self").selectivePermission("quickshopaddon.list.other")
                .executor(new SubCommand_List(plugin)).build());

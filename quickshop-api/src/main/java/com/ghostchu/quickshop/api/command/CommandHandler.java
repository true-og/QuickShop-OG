 ...
 *
 * @param <T> The required sender class you want, must is the subtype of
 *            {@link CommandSender}
 */
public interface CommandHandler<T extends CommandSender> {
     ...
     * @param parser       The command parser which include arguments and colon
     *                     arguments
     */
     ...
     *             {@link #onCommand(T, String, CommandParser)} instead.
     */
    ...
    @Nullable
    default List<String> onTabComplete_Internal(@NotNull T sender, @NotNull String commandLabel,

...
public abstract class AbstractEconomy implements EconomyCore, Reloadable {
    ...
    public boolean withdraw(@NotNull Object obj, double amount, @NotNull World world, @Nullable String currency) {
        ...
        throw new IllegalArgumentException("The obj argument can only accept one of those type: "
                + "QUser = player quickshop user object, " + "UUID = player uuid, String = player username, "
                + "OfflinePlayer = player bukkit offline player object." + " Your given: " + obj.getClass());
    ...
    @Override
    public boolean transfer(@NotNull Object from, @NotNull Object to, double amount, @NotNull World world,
    ...
    @Override
    public boolean transfer(@NotNull String from, @NotNull String to, double amount, @NotNull World world,
            @Nullable String currency)
    {

...
public enum BuiltInShopPermission implements ShopPermissionAudience {
    ...
    PURCHASE("purchase", "purchase"), SHOW_INFORMATION("show_information", "show-information"),
    PREVIEW_SHOP("preview_shop", "preview-shop"), SEARCH("search", "search"), DELETE("delete", "delete"),
    RECEIVE_ALERT("alert.receive", "receive-alert"), ACCESS_INVENTORY("access_inventory", "access-inventory"),
    ...
    TOGGLE_DISPLAY("toggle_display", "toggle-display"), SET_SHOPTYPE("set_shoptype", "set-shoptype"),
    SET_PRICE("set_price", "set-price"), SET_ITEM("set_item", "set-item"),
    SET_STACK_AMOUNT("set_stack_amount", "set-stack-amount"), SET_CURRENCY("set_currency", "set-currency"),

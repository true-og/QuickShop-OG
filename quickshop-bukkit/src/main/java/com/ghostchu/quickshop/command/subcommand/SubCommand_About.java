...
public class SubCommand_About implements CommandHandler<CommandSender> {
    ...
    public void onCommand(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull CommandParser parser) {
        ...
        MsgUtil.sendDirectMessage(sender, serializer
                .deserialize(ChatColor.AQUA + "QuickShop " + ChatColor.YELLOW + QuickShop.getInstance().getFork()));
        MsgUtil.sendDirectMessage(sender, serializer.deserialize(ChatColor.AQUA + "Version " + ChatColor.YELLOW + ">> "
                + ChatColor.GREEN + QuickShop.getInstance().getVersion()));
        if (plugin.getBuildInfo().getGitInfo().getBranch().toUpperCase().contains("ORIGIN/LTS")) {

            MsgUtil.sendDirectMessage(sender,
                    serializer.deserialize(ChatColor.AQUA + "Release " + ChatColor.YELLOW + ">> " + ChatColor.GREEN
            ...
            MsgUtil.sendDirectMessage(sender, serializer.deserialize(ChatColor.AQUA + "Release " + ChatColor.YELLOW
                    + ">> " + ChatColor.GREEN
        ...
        Util.asyncThreadRun(() -> {
            ...
            try {
                ...
                if (json != null) {
                    ...
                    MsgUtil.sendDirectMessage(sender, serializer.deserialize(ChatColor.LIGHT_PURPLE

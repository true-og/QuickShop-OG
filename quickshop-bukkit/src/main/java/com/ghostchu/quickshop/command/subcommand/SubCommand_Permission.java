...
public class SubCommand_Permission implements CommandHandler<Player> {
     ...
     * @param parser       The arguments (/quickshop create stone will receive
     *                     stone)
     */
    @Override
                    ...
                    switch (operationFinal) {
                        ...
                        case "set" -> {
                            ...
                            if (groupFinal == null) {
                                ...
                                plugin.text().of(sender, "command-incorrect", "/quickshop permission user set <group>")
                                        .send();
                                return;
                    ...
                    case "list" -> {
                        ...
                        Util.asyncThreadRun(() -> {
                            ...
                            for (Map.Entry<UUID, String> map : shop.getPermissionAudiences().entrySet()) {
                                ...
                                sheet.printLine(
                                        plugin.text().of(sender, "permission.table", name, map.getValue()).forLocale());
     ...
     *                     specified instance
     * @param commandLabel The command prefix (/quickshop = qs, /shop = shop)
     * @param parser       The arguments (/quickshop create stone [TAB] will receive
     *                     stone)

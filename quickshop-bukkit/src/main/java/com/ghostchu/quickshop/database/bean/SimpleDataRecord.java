...
public class SimpleDataRecord implements DataRecord {
    ...
    public SimpleDataRecord(QUser owner, String item, String name, int type, String currency, double price,
            boolean unlimited, boolean hologram, QUser taxAccount, String permissions, String extra,
            String inventoryWrapper, String inventorySymbolLink, Date createTime, String benefit)
    {
    ...
    public SimpleDataRecord(PlayerFinder finder, ResultSet set) throws SQLException {
        ...
        this.owner = QUserImpl.deserialize(finder, set.getString("owner"),
                QuickExecutor.getSecondaryProfileIoExecutor());
        ...
        this.taxAccount = taxAccountString == null ? null

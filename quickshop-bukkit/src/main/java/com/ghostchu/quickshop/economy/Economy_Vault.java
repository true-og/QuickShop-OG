...
public class Economy_Vault extends AbstractEconomy implements Listener {
    ...
    private boolean setupEconomy() {
        ...
        if (this.vault.getName() == null || this.vault.getName().isEmpty()) {
            ...
            plugin.logger().warn("This is technical information, please send this to economy plugin author: "
    ...
    public boolean deposit(@NotNull String name, double amount, @NotNull World world, @Nullable String currency) {
        ...
        try {
            ...
            Log.transaction(Level.WARNING,
                    "Deposit player " + name + " failed, Vault response: " + response.errorMessage);
            return false;
            ...
            @Nullable String currency)
    {
        ...
        try {
            ...
            if (trader.getName() == null) {
                ...
                plugin.logger().warn("Deposit failed and player name is NULL, Player uuid: " + trader.getUniqueId()
    ...
    public boolean withdraw(@NotNull String name, double amount, @NotNull World world, @Nullable String currency) {
        ...
        try {
            ...
            this.lastError = getProviderName() + ": " + response.type.name() + " - " + response.errorMessage;
            Log.transaction(Level.WARNING,
                    "Withdraw player " + name + " failed, Vault response: " + response.errorMessage);
            return false;
            ...
            @Nullable String currency)
    {
        ...
        try {
            ...
            if (trader.getName() == null) {
                ...
                plugin.logger().warn("Withdraw failed and player name is NULL, Player uuid: {}",

...
public class WorldListener extends AbstractQSListener {
    ...
    public void onWorldLoad(WorldLoadEvent e) {
         ...
         * references. Such as hashmap lookups will fail, because the World reference is
        ...
        // Old world data
        final Map<ShopChunk, Map<Location, Shop>> oldInWorld = plugin.getShopManager().getShops(world.getName());

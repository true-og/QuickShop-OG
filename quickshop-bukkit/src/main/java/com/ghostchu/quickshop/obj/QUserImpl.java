...
public final class QUserImpl implements QUser {
    ...
    private void parseFromUUID(String string) {
        ...
        this.finder.uuid2NameFuture(this.uniqueId, true, executorService).thenAccept(result -> {
            ...
            @NotNull ExecutorService executorService)
    {
        ...
        return CompletableFuture.supplyAsync(() -> new QUserImpl(finder, string, executorService),
                QuickExecutor.getCommonExecutor());
            ...
            @NotNull ExecutorService executorService)
    {
        ...
        return CompletableFuture.supplyAsync(() -> new QUserImpl(finder, uuid, executorService),
                QuickExecutor.getCommonExecutor());
            ...
            ExecutorService executorService)
    {
        ...
        return CompletableFuture
                .supplyAsync(() -> createFullFilled(CommonUtil.getNilUniqueId(), sender.getName(), false));

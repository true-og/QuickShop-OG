...
public class ChatSheetPrinter {
    ...
    public void printCenterLine(@NotNull Component text) {
        ...
        MsgUtil.sendDirectMessage(p, QuickShop.getInstance().text().of(p, "tableformat.left_half_line").forLocale()
                .append(text).append(QuickShop.getInstance().text().of(p, "tableformat.right_half_line").forLocale()));
    ...
    public void printLine(@NotNull Component component) {
        ...
        MsgUtil.sendDirectMessage(p,
                QuickShop.getInstance().text().of(p, "tableformat.left_begin").forLocale().append(component));

...
public class MetricDataUtil {
    ...
    public String getShopName(@NotNull ShopMetricRecord record, @NotNull DataRecord dataRecord) {
        ...
        if (shopName != null) {
            ...
            if (shop != null) {
                ...
                nameBuilder.append(String.format(template, location.getWorld().getName(), location.getBlockX(),
    ...
    public String loc2String(@NotNull Location location) {
        ...
        String template = "%s %s,%s,%s";
        return String.format(template, location.getWorld().getName(), location.getBlockX(), location.getBlockY(),
                location.getBlockZ());

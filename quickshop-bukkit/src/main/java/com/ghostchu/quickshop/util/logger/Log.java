...
public class Log {
    ...
    public static List<Record> fetchLogsLevel(@NotNull Type type, @NotNull Level level) {
        ...
        try {
            ...
            return LOGGER_BUFFER.stream()
                    .filter(recordEntry -> recordEntry.getType() == type && recordEntry.getLevel() == level).toList();
    ...
    @ApiStatus.Internal
    public static void timing(@NotNull Level level, @NotNull String operation, @NotNull Timer timer,
            @Nullable Caller caller)
    {
        ...
        try {
            ...
            if (DISABLE_LOCATION_RECORDING) {
                ...
                recordEntry = new Record(level, Type.TIMING, operation + " (cost " + timer.getPassedTime() + " ms)",
                        null);
    ...
    public static class Record {
        ...
        public CompletableFuture<String> generate() {
            ...
            return CompletableFuture.supplyAsync(() -> {
                ...
                sb.append(" ");
                sb.append("(");
                sb.append(simpleClassName).append("#").append(caller.getMethodName()).append(":")
    ...
    public static final class Caller {
        ...
        public Caller(@NotNull String threadName, @NotNull String className, @NotNull String methodName,
                int lineNumber)
        {
        ...
        public static Caller create(int steps, boolean force) {
            ...
            return STACK_WALKER.walk(stream -> stream.skip(steps).findFirst().map(frame -> {

...
/**
 * Paste the paste through
 * <a href="https://bytebin.lucko.me/post">https://bytebin.lucko.me/post</a>
 * Website Author: Lucko
 * (<a href="https://github.com/lucko">https://github.com/lucko</a>)
 *
 * @author Ghost_chu
 */
public class LuckoPastebinPaster implements PasteInterface {
    ...
    public String pasteTheText(@NotNull String text) throws IOException {
        ...
        HttpResponse<String> response = Unirest.post("https://bytebin.lucko.me/post").body(text).asString();
    ...
    public String pasteTheTextJson(@NotNull String text) throws Exception {
        ...
        HttpResponse<String> response = Unirest.post("https://bytebin.lucko.me/post")
                .body(JsonUtil.getGson().toJson(new JsonPadding(text))).asString();
        if (response.isSuccess()) {

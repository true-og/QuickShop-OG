...
public class ChatProcessorInfoItem implements SubPasteItem {
    ...
    private String buildContent() {
        ...
        table.insert(
                "Adventure Text Serializer (Legacy)", CommonUtil.getClassPathRelative(LegacyComponentSerializer.class));
        table.insert(
                "Adventure Text Serializer (Gson)", CommonUtil.getClassPathRelative(GsonComponentSerializer.class));
        table.insert(
                "Adventure Text Serializer (Json)", CommonUtil.getClassPathRelative(JSONComponentSerializer.class));
        table.insert(
                "Adventure Text Serializer (BungeeChat)",
        ...
        table.insert(
                "Adventure Text Serializer (ANSI)", CommonUtil.getClassPathRelative(ANSIComponentSerializer.class));
        table.insert(

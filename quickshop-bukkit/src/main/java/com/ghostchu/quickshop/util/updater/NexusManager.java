...
public class NexusManager implements SubPasteItem {
    ...
    public @NotNull String genBody() {
        ...
        table.insert(cachedMetadata.getLastUpdate(), cachedMetadata.getLatestVersion(),
    ...
    static class NexusMetadata {
                ...
                throws DocumentException, IllegalStateException, SAXException
        {
            ...
            NexusMetadata metadata = new NexusMetadata(Long.parseLong(lastUpdate.getText()), latest.getText(),
                    release.getText());

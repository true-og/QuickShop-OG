...
public class QuickExecutor {
    ...
    private static final ExecutorService DATABASE_EXECUTOR = new ThreadPoolExecutor(2, 16, 60L, TimeUnit.SECONDS,
            new LinkedBlockingQueue<>());

    private static final ExecutorService SHOP_SAVE_EXECUTOR = new ThreadPoolExecutor(0, 16, 60L, TimeUnit.SECONDS,
            new LinkedBlockingQueue<>());
    ...
    private static ExecutorService PRIMARY_PROFILE_IO_EXECUTOR = new ThreadPoolExecutor(2, 32, 60L, TimeUnit.SECONDS,
            PRIMARY_PROFILE_IO_QUEUE);
    private static final BlockingQueue<Runnable> SECONDARY_PROFILE_IO_QUEUE = new LinkedBlockingDeque<>();
    private static ExecutorService SECONDARY_PROFILE_IO_EXECUTOR = new ThreadPoolExecutor(2, 32, 60L, TimeUnit.SECONDS,
            SECONDARY_PROFILE_IO_QUEUE);
